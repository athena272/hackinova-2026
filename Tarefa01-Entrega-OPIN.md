...
**Projeto:** redução do absenteísmo em consultas/exames especializados do SUS em Aracaju  
...
### 2. Evidências
- Absenteísmo **>50%** em especialidades como oftalmologia e neurologia (SMS, 1º quadrimestre/2025).
...
| | |
|---|---|
| **Pensa/sente** | “Se eu perder, não sei quando volto.” Ansiedade e incerteza. |
| **Vê** | Filas longas, canais confusos, mutirões pontuais. |
| **Ouve** | “Atualize o telefone”, “se faltar vai ao fim da fila”. |
| **Fala/faz** | Anota a data; às vezes falta e não avisa; prioriza trabalho/família. |
| **Dores** | Esquecimento, remarcação burocrática, custo de transporte/renda. |
| **Ganhos** | Lembrete claro, confirmação em 1 toque, remarcação simples. |

### 5. Jobs to Be Done
> Quando tenho consulta/exame especializado marcado no SUS,  
> quero ser lembrada, confirmar presença e remarcar facilmente,  
> para não perder a vaga e não prejudicar quem está na fila.

**Job da gestão:** identificar risco de falta cedo o bastante para reaproveitar a agenda.

### 6. Alternativas atuais
Ligações manuais, Portal/App Mais Saúde Cidadão, UBS/0800, overbooking empírico e campanhas de conscientização.  
...
4. priorização de alto risco de falta (IA);
5. lista de espera ativa para reaproveitar horários.

**IA como meio:** score de propensão à falta + timing inteligente de contato.  
**Fora de escopo agora:** substituir sistemas da SMS ou fazer diagnóstico clínico.
